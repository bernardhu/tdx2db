...
var gpbase = []gpColumnDesc{
	...
	{typ: 26, name0: "f260", desc0: "拟增持金额(万元)", name1: "261", desc1: "拟减持金额(万元)"},
	{typ: 27, name0: "f270", desc0: "市场人气排名", name1: "f271", desc1: "通达信研究行业人气排名"},
	{typ: 28, name0: "f280", desc0: "股票回购均价(元)", name1: "f281", desc1: "股票回购数量(万股)"},
	{typ: 29, name0: "f290", desc0: "是否复牌日", name1: "291", desc1: "是否更名日"}, //注：是否复牌日说明：0-不是复牌日，n(n>0)-停牌n个交易日之后的复牌日；是否更名日说明：0-未更名，1-常规更名，2-加ST，3-加*ST，4-摘帽，5-其他
...
var scbase = []gpColumnDesc{
	{typ: 1, name0: "sc10", desc0: "沪深京融资余额(万元)", name1: "sc11", desc1: "沪深京融券余额(万元)"},
	{typ: 2, name0: "sc20", desc0: "沪股通流入金额(亿元)", name1: "sc21", desc1: "深股通流入金额(亿元)"},
	{typ: 3, name0: "sc30", desc0: "涨停股个数", name1: "sc31", desc1: "曾涨停股个数"},
	{typ: 4, name0: "sc40", desc0: "跌停股个数", name1: "sc41", desc1: "曾跌停股个数"},
	{typ: 5, name0: "sc50", desc0: "上证50股指期货净持仓(手)", name1: "", desc1: ""},
	{typ: 6, name0: "sc60", desc0: "沪深300股指期货净持仓(手)", name1: "", desc1: ""},
	{typ: 7, name0: "sc70", desc0: "中证500股指期货净持仓(手)", name1: "", desc1: ""},
	{typ: 8, name0: "sc80", desc0: "ETF基金规模(亿份)", name1: "sc81", desc1: "ETF净申赎(亿份)"},
	{typ: 9, name0: "sc90", desc0: "新增自然人数量(户)", name1: "sc91", desc1: "新增非自然人数量(户)"},
	{typ: 10, name0: "sc100", desc0: "增持额(万元)", name1: "sc101", desc1: "减持额(万元)"},
	{typ: 11, name0: "sc110", desc0: "溢价大宗成交额(万元)", name1: "sc111", desc1: "折价大宗成交额(万元)"},
	{typ: 12, name0: "sc120", desc0: "限售解禁计划额(亿元)", name1: "sc121", desc1: "限售解禁实际上市额(亿元)"},
	{typ: 13, name0: "sc130", desc0: "市场总分红额(亿元)", name1: "", desc1: ""},
	{typ: 14, name0: "sc140", desc0: "市场总募资额(亿元)", name1: "", desc1: ""},
	{typ: 15, name0: "sc150", desc0: "封板成功资金(亿元)", name1: "sc151", desc1: "封板失败资金(亿元)"},
	{typ: 16, name0: "sc160", desc0: "龙虎榜买入总金额(亿元)", name1: "sc161", desc1: "龙虎榜卖出总金额(亿元)"},
	{typ: 17, name0: "sc170", desc0: "龙虎榜机构买入金额(亿元)", name1: "sc171", desc1: "龙虎榜机构卖出金额(亿元)"},
	{typ: 18, name0: "sc180", desc0: "龙虎榜营业部买入金额(亿元)", name1: "sc181", desc1: "龙虎榜营业部卖出金额(亿元)"},
	{typ: 19, name0: "sc190", desc0: "龙虎榜沪深股通买入金额(亿元)", name1: "sc191", desc1: "龙虎榜沪深股通卖出金额(亿元)"},
	{typ: 20, name0: "sc200", desc0: "沪股通净买入额(亿元)", name1: "sc201", desc1: "深股通净买入额(亿元)"},
	{typ: 21, name0: "sc210", desc0: "深市无限售质押率(%)", name1: "sc211", desc1: "沪市无限售质押率(%)"},
	{typ: 22, name0: "sc220", desc0: "深市有限售质押率(%)", name1: "sc221", desc1: "沪市有限售质押率(%)"},
	{typ: 23, name0: "sc230", desc0: "连板股个数(含ST/未开板新股)", name1: "sc231", desc1: "连板股个数(不含ST/未开板新股)"},
	{typ: 24, name0: "sc240", desc0: "涨停股个数(不含ST/未开板新股)", name1: "sc241", desc1: "跌停股个数(不含ST股)"},
	{typ: 25, name0: "sc250", desc0: "沪深京融资买入额(万元)", name1: "sc251", desc1: "沪深京融券卖出量(万股)"},
	{typ: 26, name0: "sc260", desc0: "每周市场质押比例(%)", name1: "", desc1: ""},
	{typ: 27, name0: "sc270", desc0: "央行公开市场净投放(亿元)", name1: "", desc1: ""},
	{typ: 28, name0: "sc280", desc0: "历史新高股票个数", name1: "sc281", desc1: "历史新低股票个数"},
	{typ: 29, name0: "sc290", desc0: "120天新高股票个数", name1: "sc291", desc1: "120天新低股票个数"},
	{typ: 30, name0: "sc300", desc0: "市场高度(不含ST/未开板新股)", name1: "sc301", desc1: "2板以上涨停个数(不含ST/未开板新股)"},
	{typ: 31, name0: "sc310", desc0: "涨家数(剔除停牌)", name1: "sc311", desc1: "跌家数(剔除停牌)"},
	{typ: 32, name0: "sc320", desc0: "20天新高股票个数", name1: "sc321", desc1: "20天新低股票个数"},
	{typ: 33, name0: "sc330", desc0: "涨停封单金额(亿元)", name1: "sc331", desc1: "跌停封单金额(亿元)"},
	{typ: 34, name0: "sc340", desc0: "上涨股成交量(万手)", name1: "sc341", desc1: "下跌股成交量(万手)"},
	{typ: 35, name0: "sc350", desc0: "换手板家数", name1: "sc351", desc1: "回封率(%)"},
	{typ: 36, name0: "sc360", desc0: "曾涨停股个数(剔除ST/未开板新股)", name1: "sc361", desc1: "曾跌停股个数(剔除ST股)"},
	{typ: 37, name0: "sc370", desc0: "转融券融出市值(亿元)", name1: "sc371", desc1: "转融券期末余额(亿元)"},
	{typ: 38, name0: "sc380", desc0: "ETF基金规模(亿元)", name1: "sc381", desc1: "ETF净申赎(亿元)"},
	{typ: 39, name0: "sc390", desc0: "涨幅≥5%家数", name1: "sc391", desc1: "跌幅≥5%家数"},
	{typ: 40, name0: "sc400", desc0: "陆股通成交总额(亿元)", name1: "sc401", desc1: "陆股通成交总笔(万笔)"},
}
...
var bkbase = []gpColumnDesc{
	{typ: 5, name0: "bk50", desc0: "市盈率TTM(整体法)", name1: "bk51", desc1: "市盈率TTM(算术平均)"},
	{typ: 6, name0: "bk60", desc0: "市净率MRQ(整体法)", name1: "bk61", desc1: "市净率MRQ(算术平均)"},
	{typ: 7, name0: "bk70", desc0: "市销率TTM(整体法)", name1: "bk71", desc1: "市销率TTM(算术平均)"},
	{typ: 8, name0: "bk80", desc0: "市现率TTM(整体法)", name1: "bk81", desc1: "市现率TTM(算术平均)"},
	{typ: 9, name0: "bk90", desc0: "上涨家数", name1: "bk91", desc1: "下跌家数"},
	{typ: 10, name0: "bk100", desc0: "板块总市值(亿元,整体法)", name1: "bk101", desc1: "板块总市值(亿元,算术平均)"},
	{typ: 11, name0: "bk110", desc0: "板块流通市值(亿元,整体法)", name1: "bk111", desc1: "板块流通市值(亿元,算术平均)"},
	{typ: 12, name0: "bk120", desc0: "涨停家数", name1: "bk121", desc1: "曾涨停家数"},
	{typ: 13, name0: "bk130", desc0: "跌停家数", name1: "bk131", desc1: "曾跌停家数"},
	{typ: 14, name0: "bk140", desc0: "市场高度(不含ST/未开板新股)", name1: "bk141", desc1: "2板及以上涨停个数(不含ST/未开板新股)"},
	{typ: 15, name0: "bk150", desc0: "沪深京融资余额(万元)", name1: "bk151", desc1: "沪深京融券余额(万元)"},
	{typ: 16, name0: "bk160", desc0: "沪股通流入金额(亿元)", name1: "bk161", desc1: "深股通流入金额(亿元)"},
	{typ: 17, name0: "bk170", desc0: "开盘成交金额(万元)", name1: "", desc1: ""},
	{typ: 18, name0: "bk180", desc0: "板块股息率(算术平均)", name1: "bk181", desc1: "板块股息率(整体法)"},
	{typ: 19, name0: "bk190", desc0: "板块自由流通市值(亿元,整体法)", name1: "bk191", desc1: "板块自由流通市值(亿元,算术平均)"},
}
